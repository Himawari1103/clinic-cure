    ...
    private void login(String userName, String password) {
        th = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                LoginResult logRS = LoginController.login(userName,password);
                if (logRS != LoginResult.SUCCESS) {
                    loading.showError(logRS.getMs());
                } else {
                    loading.doneLogin(AccountModel.getAccount());
                }
            }
        });
        th.start();
