...
//        replacePanel.setBorder(new EmptyBorder(10, 20, 10, 20));
    ...
    public void setTextDate(LocalDate lcDate){
        startMonthComboBox.setSelectedItem(String.valueOf(lcDate.getMonthValue()));
        startDateTF.setText(String.valueOf(lcDate.getDayOfMonth()));
        startYearTF.setText(String.valueOf(lcDate.getYear()));

        endMonthComboBox.setSelectedItem(String.valueOf(lcDate.getMonthValue()));
        endDateTF.setText(String.valueOf(lcDate.getDayOfMonth()));
        endYearTF.setText(String.valueOf(lcDate.getYear()));
    }
